            ...
            >
                ...
                {postHover && (
                    ...
                    >
                        ...
                        <div className="flex justify-betweeen items-center gap-2 w-full">
                            {destination && (
                            ...
                            {postedBy?._id === userInfo.sub && (
                                <button 
                                    ...
                                    type="button" className="bg-white p-2 opacity-70 hover:opacity-100 text-red font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none"
                                >
                                    <AiTwotoneDelete />
                                </button>
                            )}
